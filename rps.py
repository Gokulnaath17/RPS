def ROCK():  
        ...
        parse.add_argument('-n',metavar='   Name',dest='user_name',required=False,help='Enter your name using the -n flag')
        parse.add_argument('-l',metavar='Language',dest='lang',required=False,choices=('English','Tamil','German'),help='For selecting the language with -l flag')
        ...
        def c(name,lang):
            ...
            return rps()
        if arg.user_name==None or gr[arg.lang]==None:
             c('Player','Hello')
        else:
